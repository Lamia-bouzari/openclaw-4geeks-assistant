...
/**
 * Test runner for GetAssetsSkill.
 *
 * Endpoint: GET /v1/registry/asset/me
 * Tests:
 * 1. Valid token — confirms real account assets returned with HTTP 200
...
async function testValidToken() {
  console.log('=== Test 1: Valid Token — Get My Assets ===');
  console.log('Token present:', !!process.env.FOUR_GEEKS_TOKEN);

  try {
    const skill = new GetAssetsSkill();
    const result = await skill.getAssets();
...
async function main() {
  console.log('4Geeks Get My Assets — Test Suite\n');
